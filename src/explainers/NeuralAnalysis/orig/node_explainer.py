...
from explainers.NeuralAnalysis.orig.vis import show_graph

from explainers.NeuralAnalysis.orig.concepts import ConceptSet
...
class ClearGNN(ModelBase):
    ...
    def expl_gp_neurons(self, graph, y, concepts=None, gamma=0.5, rank=1, visualise=True, labels=None, debug=False,
        ...
        from explainers.NeuralAnalysis.orig import concept_ranker
